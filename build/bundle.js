...
var _callbacks_demo = __webpack_require__(119);

var _callbacks_demo2 = _interopRequireDefault(_callbacks_demo);

var _promises_demo = __webpack_require__(121);

var _promises_demo2 = _interopRequireDefault(_promises_demo);

var _asyncawait_demo = __webpack_require__(117);

var _asyncawait_demo2 = _interopRequireDefault(_asyncawait_demo);
...
var timeout = function timeout(time, myPromise) {
...
var getUsers = function getUsers() {
    return getJSON(baseURL + '/users');
};
var getUser = function getUser(id) {
    return getJSON(baseURL + '/users/' + id);
};
var getPostComments = function getPostComments(id) {
    return getJSON(baseURL + '/posts/' + id + '/comments');
};
var getUserAlbums = function getUserAlbums(id) {
    return getJSON(baseURL + '/users/' + id + '/albums');
};
...
var waitAndShow = function () {
    ...
    return function waitAndShow() {
        return _ref.apply(this, arguments);
    };
}();

var loadWithTimeout = function () {
            ...
            while (1) {
                switch (_context2.prev = _context2.next) {
                    case 0:
                        _context2.prev = 0;
                        _context2.next = 3;
                        return AsyncAwait.timeout(500, AsyncAwait.getUsers());
    ...
    return function loadWithTimeout() {
...
var loadSequentially = function () {
    var _ref4 = _asyncToGenerator(regeneratorRuntime.mark(function _callee4() {
        var userData, albums, comments;
            ...
            while (1) {
                switch (_context4.prev = _context4.next) {
                    ...
                    case 3:
                        ...
                        _context4.next = 7;
                        return AsyncAwait.getUserAlbums(1);
                    ...
                    case 7:
                        ...
                        _context4.next = 11;
                        return AsyncAwait.getPostComments(1);
    ...
    return function loadSequentially() {
...
var parallelLoad = function () {
        ...
        return regeneratorRuntime.wrap(function _callee5$(_context5) {
            while (1) {
                switch (_context5.prev = _context5.next) {
                    case 0:
                        _context5.prev = 0;
                        userData = AsyncAwait.getUser(1);
                        albums = AsyncAwait.getUserAlbums(1);
                        comments = AsyncAwait.getPostComments(1);
    ...
    return function parallelLoad() {
        return _ref5.apply(this, arguments);
    };
}();

var _asyncawait = __webpack_require__(116);

var AsyncAwait = _interopRequireWildcard(_asyncawait);
...
var baseURL = 'https://jsonplaceholder.typicode.com';
var users = [baseURL + '/users/1', baseURL + '/users/2', baseURL + '/users/4', baseURL + '/users/6', baseURL + '/users/9'];
...
loadWithTimeout();
// or call the function as a Promise in the main code.
AsyncAwait.timeout(500, AsyncAwait.getUsers()).then(function (data) {
...
var _callbacks = __webpack_require__(118);

var Callbacks = _interopRequireWildcard(_callbacks);

function _interopRequireWildcard(obj) { if (obj && obj.__esModule) { return obj; } else { var newObj = {}; if (obj != null) { for (var key in obj) { if (Object.prototype.hasOwnProperty.call(obj, key)) newObj[key] = obj[key]; } } newObj.default = obj; return newObj; } }

var users = [Callbacks.baseURL + '/users/1', Callbacks.baseURL + '/users/2', Callbacks.baseURL + '/users/4', Callbacks.baseURL + '/users/6', Callbacks.baseURL + '/users/9'];
...
console.log('load users');
try {
    Callbacks.getUsers(function (jsonData) {
...
try {
    Callbacks.getUser(1, function (userData) {
        console.log('User data:', userData);
        try {
            Callbacks.getUserAlbums(1, function (albumData) {
                console.log('Albums:', albumData);
                try {
                    Callbacks.getPostComments(1, function (comments) {
...
try {
    users.map(function (userURL) {
        Callbacks.getJSON(userURL, dataLoaded, function (error) {
            console.log(error);
        });
    });
} catch (error) {
...
var _promises = __webpack_require__(120);
...
console.log('load with timeout');
Promises.timeout(500, Promises.getUsers()).then(function (data) {
    return console.log(data);
}).catch(function (error) {
    return console.log(error);
});
...
console.log('load users');
Promises.getUsers().then(function (jsonData) {
...
// 3 sequential Ajax request with error handling
console.log('load user extras sequentially');
Promises.getUser(1).then(function (userData) {
    console.log('User data:', userData);
    ...
    return console.log('Comments:', comments);
}).catch(function (error) {
    return console.log(error);
});
...
// 3 parallel Ajax requests with a trigger when all have completed
console.log('load user extras in parallel');
Promise.all([Promises.getUser(1), Promises.getPostComments(1), Promises.getUserAlbums(1)]).then(function (data) {
    return console.log('All done', data);
}).catch(function (error) {
    return console.log(error);
});

var promiseArr = users.map(function (userURL) {
    return Promises.getJSON(userURL);
});
Promise.all(promiseArr).then(function (userData) {
